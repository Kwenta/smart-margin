...
contract UpgradeTest is Test {
    // BLOCK_NUMBER_UPGRADE corresponds to Optimism network state @ Jul-05-2023 06:35:17 PM +UTC
    // hard coded addresses are only guaranteed for this block
    uint256 private constant BLOCK_NUMBER_UPGRADE = 106_491_670;
    ...
    function test_Deployed_Account_Version() public {
        ...
        assertEq(version, "2.0.2", "wrong version");
    }
