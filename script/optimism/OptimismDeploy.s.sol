...
/// (2) run `forge script script/OptimismDeploy.s.sol:OptimismDeployScript --rpc-url $ARCHIVE_NODE_URL_L2 --broadcast -vvvv`
contract OptimismDeployScript is Script {
    ...
    /// @notice deploy Kwenta's Smart Margin Account Factory on Optimism
    function run() public {
